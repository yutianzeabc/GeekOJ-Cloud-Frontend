import Answer from '@/pages/Question/QuestionDetail/components/Answer';
import Content from '@/pages/Question/QuestionDetail/components/Content';
import Editor from '@/pages/Question/QuestionDetail/components/Editor';
import LogDetail from '@/pages/Question/QuestionDetail/components/LogDetail';
import SubmitLog from '@/pages/Question/QuestionDetail/components/SubmitLog';
import { doQuestionRun } from '@/services/judge/api';
...
const QuestionDetail: React.FC = () => {
  ...
  const [question, setQuestion] = useState<Question.SafeQuestion>();
  ...
  const [testResult, setTestResult] = useState<QuestionRun.QuestionRunResult>();
  ...
  useEffect(() => {
    getSafeQuestionById(questionId).then((res) => {
      if (res.code === 200) {
            ...
            <div style={{ padding: 8 }}>
              ...
              <Space style={{ float: 'right' }}>
                <Button
                  ...
                  disabled={!question || !currentUser || targetSubmitId > 0 || testResultLoading}
                  size="small"
